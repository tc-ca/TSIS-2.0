interface ppp_Caller_Base extends WebEntity {
  ...
  ppp_calldate?: Date | null;
  ppp_calldatetime?: Date | null;
  ppp_callerid?: string | null;
  ppp_callername?: string | null;
  ppp_calltimehour?: number | null;
  ppp_calltimeminute?: number | null;
...
interface ppp_Caller_Select {
  ...
  ppp_calldate: WebAttribute<ppp_Caller_Select, { ppp_calldate: Date | null }, { ppp_calldate_formatted?: string }>;
  ppp_calldatetime: WebAttribute<ppp_Caller_Select, { ppp_calldatetime: Date | null }, { ppp_calldatetime_formatted?: string }>;
  ...
  ppp_calltimehour: WebAttribute<ppp_Caller_Select, { ppp_calltimehour: number | null }, {  }>;
  ppp_calltimeminute: WebAttribute<ppp_Caller_Select, { ppp_calltimeminute: number | null }, {  }>;
...
interface ppp_Caller_Filter {
  ...
  ppp_calldate: Date;
  ppp_calldatetime: Date;
  ppp_callerid: XQW.Guid;
  ppp_callername: string;
  ppp_calltimehour: number;
  ppp_calltimeminute: number;
  ppp_name: string;
...
interface ppp_Caller_FormattedResult {
  ...
  ppp_calldate_formatted?: string;
  ppp_calldatetime_formatted?: string;
